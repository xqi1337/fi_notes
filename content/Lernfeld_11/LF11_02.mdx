...
> **Definition/Zweck:** Umfassende Integration von Netzwerk- und Anwendungsebenen-Sicherheit durch IPsec, L2TP und TLS mit detaillierter Analyse der Protokollabläufe und Sicherheitsmechanismen

## Inhaltsverzeichnis

- [SPD (Security Policy Database)](#spd-security-policy-database)
- [IKEv2 / L2TP-IPsec](#ikev2--l2tp-ipsec)
- [Diffie-Hellman-Gruppen](#diffie-hellman-gruppen)
- [SSL / TLS Integration](#ssl--tls-integration)
- [Zusammenfassung der Schichten](#zusammenfassung-der-schichten)
- [Textbasiertes Protokoll-Diagramm](#textbasiertes-protokoll-diagramm)
- [Anhang: Kryptografische Grundlagen](#anhang-kryptografische-grundlagen)
---
